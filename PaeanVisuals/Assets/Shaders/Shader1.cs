...
public class Shader1 : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       // compute_shader.SetFloat("liquide", liquide);
        ...
        compute_shader.SetFloat("audio1", audio+osc.audio1+osc.low*osc.audio2 * osc.address01 * osc.fac2);
        compute_shader.SetFloat("audio2", audio + osc.audio1 + osc.high * osc.audio2 * osc.address03 * osc.fac2);
