...
public class controllCave : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        obj1._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj2._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj3._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj4._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj5._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj6._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj7._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj8._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj9._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj10._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj11._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj12._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj13._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj14._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj15._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj16._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
        obj17._audio3 = osc.high2 * osc.address03 * osc.audio2 * osc.fac2;
