...
public class RunCompute : MonoBehaviour {
    ...
    public GameObject particulesObj;
    ...
    void InitComputeShader()
    {
        ...
        for (int i = 0; i < particleCount; i++)
        {
            ...
            particleArray[i].velocity.x = x;
            particleArray[i].velocity.y = y;
            particleArray[i].velocity.z = z;
    ...
    void Update () {
        ...
        computeShader.SetFloat("p1", particulesObj.transform.position.x);
        computeShader.SetFloat("p2", particulesObj.transform.position.y);
        computeShader.SetFloat("p3", particulesObj.transform.position.z);
